...
%previousTimeStamp(T, Timestamps, Tprev):- Tprev is T - 1, happensAt(_, Tprev).
%previousTimeStamp(T, Timestamps, Tprev):- Tp is T -1 , \+ happensAt(_, Tp), previousTimeStamp(Tp, Timestamps, Tprev).
